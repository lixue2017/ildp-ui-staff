  ...
  <div class="detail-table">
    <template v-for="(item, index) in table">
      <div :key="index">
        ...
        <div class="grand-total" v-if="item.grossTotal">
...
import { goodsTable, predictionGoodsTable } from "./model";
export default {
  props: {
    formModel: {
      type: Object,
  ...
  data() {
    return {
      productDefaultLogo,
      table: [goodsTable(), predictionGoodsTable],
      tableData: [],
      httpRequest: {
        0: getBoxList,
        1: getFreightList,
          ...
          if (index === 1) {
            res.rows = res.rows.map((item) => {
              ...
              return {
                ...
                calcBoxCount: item.deleted ? 0 : item.boxCount,
