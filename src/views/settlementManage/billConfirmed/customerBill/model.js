import { httpAllDealingCompanySelect, httpUserSelect, httpRoleDeptUserSelect, httpLogisticsCustomerSelect } from '@/comModel/httpSelect'
...
export const confirmDialogCols = (obj) => {
	const { status, settleModel } = obj || {};
	let simpleCustomCols = []
	if (settleModel === 2 && status != '1') {
  ...
  return {
    ...
    simpleCustomCols,
      ...
      [status === '1' ? 'resultRemark' : 'no_xx']: [ // 打回必填
