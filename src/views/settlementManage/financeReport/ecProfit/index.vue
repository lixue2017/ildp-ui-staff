      ...
      <template v-for="tab in tabsConfig.tabs">
        <el-tab-pane :label="tab.label" :name="tab.name" :key="tab.name">
          ...
          <div
            :style="{
              'margin-top':
                searchFormConfig.formModelLength >= 20 ? '0px' : '30px',
            }"
          >
            <ComTable
...
export default {
  ...
  methods: {
    ...
    getSearchList(searchFrom = {}) {
      const { customerId, customerName, monthBy } =
        this.searchFormConfig.formModel;
      this.searchFromData = {
        customerId,
        customerName,
    ...
    getResult({ resultData }) {
      ...
      // this.$refs.tableTotal1 && this.$refs.tableTotal1[0].refreshTable(true);
    },
  },
  components: {
