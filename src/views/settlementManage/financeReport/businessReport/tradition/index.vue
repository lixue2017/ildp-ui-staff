        ...
        <el-tab-pane :label="tab.label" :name="tab.name" :key="tab.name">
              ...
              <template v-slot:salesmanId="slotProps">
                <!-- <AutoComplete
                  ...
                  :additionalParam="{
                    ...
                    startTime: slotProps.formModel.oDate
                      ? slotProps.formModel.oDate[0]
                      : getCurrDate()[0],
                    endTime: slotProps.formModel.oDate
                      ? slotProps.formModel.oDate[1]
                      : getCurrDate()[1],
                  }"
                /> -->
                <AutoComplete
          ...
          <keep-alive>
            <ComTable
              ...
              :columnConfig="tableColumns_tradition({currencyList})"
...
import {
  searchFormCols,
  tableColumns_tradition,
  formRules,
} from "../components/model.js";
import {
  getTraditionReportEC,
  traditionReportExport,
  traditionEnReportExport,
...
export default {
  ...
  data() {
    ...
    // const isEn = path.split("/").includes("traditionEn");
    return {
      // isEn,
      tableColumns_tradition,
      accumulationFn,
      ...
      tableConfig: {
        ...
        httpRequest: getTraditionReportEC,
      },
      subtotalMoney: [],
      totalData: {},
      currencyList:[]
      // mixinTableColArr: [tableColumns_tradition(isEn)],
    };
  },
  mounted() {
  ...
  methods: {
    ...
    handleExport(isEnExport) {
      ...
      const req = isEnExport ? traditionEnReportExport : traditionReportExport;
      comFileDownload(this, req, params);
    },
    searchConfig() {
      return {
        ...this.formConfig,
