  ...
  methods: {
    ...
    handleExport() {
      comFileDownload(this, settleAccountsStayExport, {
        ...
        exportType: { 1: 4, 2: 5, 3: 6 }[this.tabsConfig.activeName],
      });
    },
    getList(searchFrom = {}) {
    ...
    generateBill() {
      ...
      //dealingsCompanyName 往来单位  currency币种  billingMainName记账主体
      const { activeName } = this.tabsConfig;
      const selectRows = this.selectionRows[activeName];
      const { billingMain, dealingsCompany, type, currencyId } = selectRows[0];
