...
import { ecSubmitted } from "@/views/operateManage/operateRecord/components/customsClearance.js";
import { getEsConfirmed } from "@/api/performance/record.js";
export default {
  name: "EcSubmitted",
  ...
  data() {
    return {
      ...
      tableConfig: {
        httpRequest: getEsConfirmed,
        getQueryParams: this.getQueryParams,
      },
      mixinTableColArr: [ecSubmitted().tableColumns],
      tabTableObj: {
        1: ecSubmitted().tableColumns,
      },
      searchFromData: {},
    };
  },
