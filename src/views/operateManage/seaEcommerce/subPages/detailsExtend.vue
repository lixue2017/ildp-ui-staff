  ...
  methods: {
    ...
    getDetails(id) {
      ...
      getOperationDetailExtend(id).then(async (res) => {
        ...
        if (data.isMainBill !== 5) {
          const query = this.$route.query;
          const path = "/operateManage/ecOperateDetails";
    ...
    tabColumns() {
      ...
      if (
        !this.initInfo.containerTrailerShow ||
        this.initInfo.operationOrderType === 1
      ) {
