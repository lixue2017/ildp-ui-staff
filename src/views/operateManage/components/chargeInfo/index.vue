<template>
  <div class="detail-table">
    ...
    <div class="bill-btn">
      ...
      <el-button size="small" type="primary" plain round> 新增账单 </el-button>
    </div>
    <ComTable
      ref="tableConfig"
...
export default {
  ...
  created() {
    ...
    if (this.isOutStorage) this.tableConfig.columnConfig.pop();
  },
  methods: {
    // getTableResult(data) {
    ...
    getQueryParams() {
      return {
        ...
        orderId: this.formModel.id, // 操作单idid
      };
    },
    refreshTable() {
