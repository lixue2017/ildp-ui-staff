            ...
            >
              <template v-slot:customRow="{ slotProps }">
                ...
                <template v-if="slotProps.prop === 'size'">
                  <span v-if="slotProps.row.size">
                    {{ slotProps.dicsList.nameCn }}
                  </span>
                  <span v-else>--</span>
                </template>
                <template v-if="slotProps.prop === 'box'">
                  <span v-if="slotProps.row.box">
                    {{ slotProps.dicsList.nameCn }}
                  </span>
                  <span v-else>--</span>
                </template>
...
import { getsizeList } from "@/api/operationalData";
...
export default {
  ...
  data() {
    return {
      ...
      consigneeTable: {
        ...
        httpRequest: (query) => getsizeList(query, true),
  ...
  created() {
    this["dictionary/getDictionary"]("bosSizeTypeEn").then((res) => {
