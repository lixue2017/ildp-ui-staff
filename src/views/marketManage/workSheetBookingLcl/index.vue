...
import { workSheetBookingLcl } from "@/views/marketManage/components/broking/model.js";
export default {
  name: "WorkSheetBookingLcl",
  mixins: [mixinColsConf, mixinBroking],
  components: {
    SoNoCheckIn: () =>
      import(
  ...
  data() {
    ...
    return {
      ...
      tableConfig: {},
      mixinTableColArr: [
        workSheetBookingLcl().tableColumns[1],
        workSheetBookingLcl().tableColumns[2],
      ],
    };
  },
  computed: {
