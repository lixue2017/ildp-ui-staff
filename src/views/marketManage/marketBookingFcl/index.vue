        ...
        <el-tab-pane :label="tab.label" :name="tab.name" :key="tab.name">
          ...
          <keep-alive v-if="mixinShowTable">
            <ComTable
              ...
              :rowOperationBtnListFn="(row) => statusBtnListFn(tab.name, row)"
              ...
              <template v-slot:customRow="{ slotProps }">
                <template v-if="slotProps.prop === 'isBookingSpace'">
                  <div>
                    <div
                      v-if="
                        slotProps.row.isBookingSpace ||
                        slotProps.row.isBookingSpace === 0
                      "
...
import { marketBookingFcl } from "@/views/marketManage/components/broking/model.js";
export default {
  name: "MarketBookingFcl",
  ...
  components: {
    ...
    BookingDialog: () => import("../components/bookingRegistration"),
  ...
  data() {
    return {
      ...
      tableConfig: {},
      mixinTableColArr: [
        marketBookingFcl().tableColumns[1],
        marketBookingFcl().tableColumns[2],
      ],
    };
  },
  computed: {
    // ...mapState(["dictionary"]),
    ...mapState({
      isBookingSpaceStatus: (state) =>
        state.dictionary.dicsData.isBookingSpaceStatus,
